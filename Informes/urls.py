...
urlpatterns = [
    ...
    path('listar-solicitudes-pendientes-admin/<int:id_usuario>/', ListarSolicitudesPendientesAdminView.as_view(), name='listar_solicitudes'),
    path('listar-solicitudes-canceladas-admin/<int:id_usuario>/', ListarSolicitudesCanceladasAdminView.as_view(), name='listar_solicitudes_canceladas'),
    path('listar-solicitudes-aceptadas-admin/<int:id_usuario>/', ListarSolicitudesAceptadasAdminView.as_view(), name='listar_solicitudes_aceptadas'),
    ...
    path('listar-detalle-facturas/<int:id_usuario>/<int:id_informe>/', ListarDetalleFacturasView.as_view(), name='listar_detalle_facturas'),
    ...
    path('generar_pdf_solicitud/<int:id_usuario>/<int:id_solicitud>/pdf/', GenerarPdfSolicitudView.as_view(), name='generar_solicitud_pdf'),
 ]